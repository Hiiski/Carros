    ...
    <main className="min-h-svh bg-offwhite py-20 px-6">
      ...
      <section>
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <a className="font-lexend bg-offwhite block px-10 py-3 w-fit rounded-3xl text-dark-green" href="https://www.webmotors.com.br/carros-de-luxo" target="_blank">Ver mais</a>
        </div>
